...
import { requireCloseSyncAfterOpenSyncRule } from "./rules/require-closesync-after-opensync";
...
const plugin = {
  ...
  rules: {
    ...
    "require-closesync-after-opensync": requireCloseSyncAfterOpenSyncRule,
  },
};
